...
def solution(cave_row, cave_col, cave, throw_num, throws):
    ...
    총 시간 복잡도: O(throw_num * cave_col^2 * cave_row) 
    = O(10^2 * 10^4 * 10^2) = O(10^8)
    -> bfs 로 실제로는 10^8보다 작은 듯
